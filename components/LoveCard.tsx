...
export default function LoveCard({ flower, children }: LoveCardProps) {
    ...
    const gridClasses = isExporting ? 'grid-cols-1' : 'grid-cols-1 lg:grid-cols-2';
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                ...
                >
                    {isExporting === 'image' ? <span className="animate-spin">⏳</span> : 'Télécharger en Image HD'}
                </button>
                <button
                ...
                >
                    {isExporting === 'pdf' ? <span className="animate-spin">⏳</span> : 'Télécharger en PDF'}
                </button>
            </div>
        </div>
    );
