                ...
                <div className="space-y-6">
                    <div className="bg-white rounded-2xl p-4 md:p-6 shadow-lg border border-pink-100">
                        <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
                            ...
                            <h3 className="font-dancing text-2xl md:text-3xl text-primary">Votre fleur magique</h3>
                        </div>
                        ...
                        <div className="bg-linear-to-r from-pink-50 to-white p-4 md:p-6 rounded-xl border-l-4 border-primary">
                            <div className="flex items-start gap-2 md:gap-3">
                                ...
                                <div>
                                    <p className="text-sm md:text-lg italic text-gray-700 leading-relaxed">{flower.message}</p>
                    ...
                    <div className="bg-white rounded-2xl p-4 md:p-6 shadow-lg border border-pink-100">
                        <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
                            ...
                            <h4 className="font-dancing text-xl md:text-2xl text-primary">Compatibilité</h4>
                        </div>
                        ...
                        <div className="space-y-3 md:space-y-4">
                            ...
                            <p className="text-sm md:text-base text-gray-700">
                                Cette fleur représente{' '}
                                <span className="font-semibold text-primary">{getCompatibilityText(flower.compatibility)}</span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="text-center text-gray-600 text-xs md:text-sm">
                        <div className="flex items-center justify-center gap-2">
                            ...
                            <span>ID :</span>
                            <span className="font-mono font-semibold text-primary">{flower.unique_id}</span>
                        </div>
                    </div>
                </div>
            </LoveCard>
